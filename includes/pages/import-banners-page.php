...
function rg_coupons_banner_import_page()
			...
			<table class="inline-table">
				...
				<tr>
					...
					<td>
						...
						<button id="rg_coupon_sub_activate" class="button-primary float-left" style="margin-right:5px;">Validate Account</button>
				...
				<thead>
					...
					<tr>
						...
						<td class="store-table">
							...
							<a href='rg_banners_import' class="rg_coupons_open_import_popup">Import</a> | <a href='rg_banners_delete' class="rg_coupons_open_delete_popup">Delete</a>
							...
							<a href="" id="rg_banner_import" class="rg_coupons_start_import" >Import</a> | <a href="javascript:{}" onClick="jQuery('#rg_coupons_import_popup').hide()">Cancel</a>
